...
const HomePage = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        // Select 4 for top deals and 8 for featured
  ...
  return (
    <div className="p-4">
      {/* Hero Banner */}
      <div className="w-full h-48 bg-gradient-to-r from-red-500 to-pink-500 rounded-lg text-white flex items-center justify-center mb-6 text-2xl font-bold">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        {["Electronics", "Clothes", "Shoes", "Furniture"].map((cat) => (
          <div
            ...
            className="bg-gray-100 rounded-lg shadow-sm p-6 text-center font-medium hover:bg-red-100 cursor-pointer"
          >
            {cat}
          </div>
        ))}
